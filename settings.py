...
PICNIC_EMAIL = os.environ.get("PICNIC_EMAIL", "").strip()
PICNIC_PASSWORD = os.environ.get("PICNIC_PASSWORD", "").strip()
...
HAIKU_MODEL: str = config.get("haiku_model", "claude-haiku-4-5-20251001")
