...
[ACTION:RETRIAGE_INBOX] [konto] - Räumt das Postfach auf: sucht alle DHL/Hermes/DPD/UPS/Amazon-Logistics-Mails in der INBOX und verschiebt sie retroaktiv in den konfigurierten DHL-Ordner. Ohne Konto-Angabe werden ALLE konfigurierten Konten durchsucht (HILO + Apple Mail). Nutze wenn {addr} sagt "räum meine DHL-Mails auf", "verschieb die Paket-Mails", "DHL-Mails sortieren", "Posteingang aufräumen". Ohne spezifisches Konto: Beispiel: [ACTION:RETRIAGE_INBOX] — mit Konto: [ACTION:RETRIAGE_INBOX] HILO
