...
[ACTION:DEBUG_PDF] [name] - Diagnose: zeigt gespeicherte PDFs in /tmp/jarvis_pdfs und was persons_db für einen Mandanten gespeichert hat. Nutze wenn {addr} fragt "Wurden die PDFs verarbeitet?", "Was hast du aus dem Bescheid extrahiert?", "Fehlerdiagnose PDF". Beispiel: [ACTION:DEBUG_PDF] Turk
[ACTION:ANALYZE_ALL_PDFS] - Verarbeitet alle bisher gespeicherten PDFs in /tmp/jarvis_pdfs/ nach und speichert die Ergebnisse in der Personen-DB. Nutze wenn {addr} sagt "Verarbeit alle PDFs", "Bescheide nachverarbeiten", "PDFs neu einlesen". KEIN Text davor.
[ACTION:RETRIAGE_INBOX] [konto] - Räumt das Postfach auf: sucht alle DHL/Hermes/DPD/UPS/Amazon-Logistics-Mails in der INBOX und verschiebt sie retroaktiv in den konfigurierten DHL-Ordner (Standard: HILO). Nutze wenn {addr} sagt "räum meine DHL-Mails auf", "verschieb die Paket-Mails", "DHL-Mails sortieren", "Posteingang aufräumen". Beispiel: [ACTION:RETRIAGE_INBOX] HILO
