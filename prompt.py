...
[ACTION:SPEISEPLAN_PREF] Vorlieben - Speichert dauerhafte Speiseplan-Vorlieben und erstellt SOFORT einen neuen Plan. Nutze wenn {addr} eine Zutat dauerhaft ausschliessen will ("keine Erbsen", "kein Schweinefleisch", "nie wieder Spinat") ODER Fisch-Regeln aendert ("Fisch nur als Lachs", "kein Fisch mehr", "nur Lachs Forellen und Dorado"). Payload-Format (Pipe fuer mehrere): avoid:Zutat | fish:Art1,Art2 | fish_weekly:false. Beispiele: [ACTION:SPEISEPLAN_PREF] avoid:Erbsen --- [ACTION:SPEISEPLAN_PREF] fish:Lachs,Forellen,Dorado --- [ACTION:SPEISEPLAN_PREF] avoid:Spinat|fish:Lachs,Forellen Neues Rezept wird automatisch generiert. Nutze wenn {addr} sagt "Tausch Montag gegen ...", "Montag lieber Pasta", "Ersetze Dienstag durch ...". Beispiel: [ACTION:SPEISEPLAN_SWAP] Montag|Pasta mit Gemüse
