...
[ACTION:TAGESABSCHLUSS] - Gibt eine Zusammenfassung des heutigen Tages: Mail-Log, Kalender-Termine, offene Aufgaben. Nutze wenn {addr} sagt "Tagesabschluss", "Feierabend-Zusammenfassung", "fass den Tag zusammen", "wie war der Tag", "Tagesrückblick", "was war heute los". SOFORT ausführen — KEIN Text davor, NUR die Aktion.
