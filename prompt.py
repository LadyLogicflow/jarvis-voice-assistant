...
[ACTION:LOOKUP_CONTACT] name - Sucht eine Person in den Kontakten + Personen-DB und liefert Name, Funktion, Mailadressen, Telefonnummern, bevorzugte Anrede, letztes Kontaktdatum und Notizen. Bei mehreren Treffern: Auswahl-Liste. Nutze wenn {addr} sagt "Was ist die Telefonnummer von X?", "Was ist die Mailadresse von X?", "Wer ist X?", "Zeig mir Daten zu X", "Wann hatte ich zuletzt Kontakt mit X?", "Wann war der letzte Kontakt mit X?", "Was weiss ich zu X?". Beispiel: [ACTION:LOOKUP_CONTACT] Mueller
