...
```
cd existing_repo
git remote add origin https://git.services.cl01.efiniti.de/pandora/user-h1znvt5m/jarvis.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.services.cl01.efiniti.de/pandora/user-h1znvt5m/jarvis/-/settings/integrations)
